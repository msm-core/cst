...
export const FIELDS_L1 = [
  ...
  "know", "think", "speak", "write", "see", "feel", "decide",
  // Action & Creation
  "make", "create", "destroy", "change", "fix", "work", "enable",
  // Movement & Transfer
  "move", "send", "give", "take", "gather", "hold", "open", "hide", "connect",
  // Existence & State
  "exist", "rest", "want",
  // Social & Power
  ...
  // Physical World
  "nature", "weather", "animal", "plant", "body", "food", "material", "color",
  // Space, Time & Measure
  "time", "place", "dwell", "structure", "size", "measure", "quality",
  // Classification & Reference
  "person", "name", "contain", "force",
] as const;
...
export function isValidField(s: string): s is Field {
  return (FIELDS_L1 as readonly string[]).includes(s) ||
